...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2018 at 12:28 PM
...
INSERT INTO `users` (`id`, `name`, `role`, `email`, `username`, `password`, `position`, `id_employee_status`, `birtdate`, `education`, `age`, `years_of_working`, `date_join_acs`, `flag_active`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Administrator', 1, 'user1@aerofood.com', 'user1', '$2y$10$ULk9KrZFQBOEdbIwS7A9jeUdxb9eqxpy7iNlFvWPXZ7AYJ1Mlri3S', 1, 1, '1988-01-01', 'master', 30, 5, '2017-12-20', 1, 'udZArlGSti70TAlKUM6RkDNaj8VvzoRCjCBDVXi4QoxCaeHtpUJH5i7swZT8', '2017-12-31 03:14:41', '2017-12-31 03:14:41');
