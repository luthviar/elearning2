            ...
            <?php else: ?>
                <li class="dropdown user">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        <img src="<?php echo e(URL::asset('photo/user-default.png')); ?>" class="user-image" alt="User Image" width="20">
                        <?php else: ?>
                        <img src="<?php echo e(URL::asset(Auth::user()->photo)); ?>" class="user-image" alt="User Image" width="20">
                        <?php endif; ?>
