...
<link rel="icon" href="<?php echo e(URL::asset('Elegantic/images/favicon.png')); ?>" type="image/png" sizes="16x16">
...
<script type="text/javascript" src="<?php echo e(URL::asset('js/js-override.js')); ?>"></script>
...
<link rel="stylesheet" href="<?php echo e(URL::asset('Elegantic/css/style-override.css')); ?>" />
