                  ...
                  <div class="box box-success text-left col-md-6" id="add_material_form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-success col-md-6">
                          <div class="box-body">
                            ...
                            <p>
                              ...
                              <a href="<?php echo e(URL::asset($file->url)); ?>" class="btn btn-default" style="width: 90%"><?php echo e($file->name); ?></a><span class="pull-right">
                              <a href="<?php echo e(url('remove_material_file', $file->id)); ?>"><i class="fa fa-times" style="color: red" aria-hidden="true">remove</i></a></span>
                        ...
                        <div class="box box-warning col-md-6">
                          ...
                          <!-- /.box-header -->
                          <div class="box-body">
                          <form method="post" action="<?php echo e(url('material_add')); ?>" enctype="multipart/form-data">
                            <h5>Form Upload</h5>
                            <!-- Title -->
