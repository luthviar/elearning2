                    ...
                    <div class="">
                        ...
                        <div class="" >
                            <form
                                    ...
                                    action="<?php echo e(URL::action('ForumController@updateCommentByUser')); ?>"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea id ="" rows="5" cols="72" name="content" required><?php echo e($forum->content); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <script>
                            function submit_modal<?php echo e($key); ?>(){
                                window.open('<?php echo e(url(action('ForumController@deleteAttachmentCommentByUser',$file->id))); ?>','_self')
                                //$('#form_delete').submit();
                            }
                        </script>
