      ...
      <div class="box box-primary">
            ...
            <div class="box-body">
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="textarea" name="question_text" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $question->question_text; ?></textarea>
                </div>
                  ...
                  <div class="input_fields_wrap col-md-12" style="padding-top: 10px;">
                    ...
                    <div class="col-md-12" style="padding-bottom: 5px;">
                        <input type="text" class="form-control" value="<?php echo e($option->option_text); ?>" style="width: 80%;" placeholder="input option" name="option[]">
                    </div>
                    <?php else: ?>
