 <html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('onlinetest/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('onlinetest/sweetalert.css')); ?>">
    <style>
      @font-face {
        font-family: 'ttbold';
        src: url('<?php echo e(url('onlinetest/TypeType-TTLakesCondensed-Bold.otf')); ?>');
      }
      ...
      #start-stage:active img {
        content: url('<?php echo e(url('onlinetest/btn-clicked-3.png')); ?>');
      }
    ...
    <script src="<?php echo e(url('js/ifvisible.js')); ?>"></script>
    <script>
...
//                animations.resume();
          ...
          <div class="pull-left">
            <table class="nav-table">
              ...
              <tr>
                ...
                <td class="bg-yellow">
                  <div id="timer"
                       data-minutes-left="<?php echo e($test->time); ?>"
                       class="text-white"
                       style="font-size:24px;font-weight:bold"><?php echo e($test->time); ?></div>
                </td>
                <td class="bg-red">
          ...
          <div class="question-list-item">
            ...
            <div>
              <h3>
                <b>
                  ...
                  <div class="question-number-circle bg-red text-center" style="position: relative;top: -4px;">
                    <span class="v-align-sub text-white"><?php echo e($key+1); ?></span>
                  </div>&nbsp;&nbsp;&nbsp;
              ...
              <ol type="A" style="list-style:none">
                ...
                <?php $__currentLoopData = $question['option']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyopt => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                  <input type="radio"
                         name="<?php echo e($question->id); ?>"
                         onclick="count_answer(<?php echo e($key); ?>)"
                         id="<?php echo e($option['id']); ?>"
                         value="<?php echo e($option['id']); ?>">

                  <label for="<?php echo e($option['id']); ?>">
                    <div class="choice-circle text-white text-center bg-grey">
                      <span class="v-align-middle"><?php echo $char++; ?></span>
                    </div>&nbsp;<?php echo e($option['option_text']); ?>
                ...
                <div hidden><?php echo e($char = 'A'); ?></div>
              </ol>
            </div>
  ...
  <script src="<?php echo e(url('js/jquery.min.js')); ?>" defer="defer"></script>
  <script src="<?php echo e(url('onlinetest//moment.js')); ?>" defer="defer"></script>
  <script src="<?php echo e(url('onlinetest/moment-timezone.js')); ?>" defer="defer"></script>
  <script src="<?php echo e(url('js/bootstrap.min.js')); ?>" defer="defer"></script>
  <script>
      var finish = "http://iseec-ui.com/ISEEC/preliminary/online-test/finish";
  </script>
  <script src="<?php echo e(url('onlinetest/sweetalert.min.js')); ?>" defer="defer"></script>
  <script src="<?php echo e(url('onlinetest/timer.jquery.min.js')); ?>" defer="defer"></script>
  <script src="<?php echo e(url('onlinetest/security.js')); ?>" defer="defer"></script>
  <script src="<?php echo e(url('onlinetest/participant-script.js')); ?>" defer="defer"></script>
  <script language="JavaScript" type="text/javascript" defer="defer">
     var timelimit = <?php echo e($test->time); ?> +"m";
  </script>
  <script src="<?php echo e(url('onlinetest/allstage.js')); ?>" defer="defer"></script>
