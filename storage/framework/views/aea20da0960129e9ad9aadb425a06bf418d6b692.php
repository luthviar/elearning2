                ...
                <?php endif; ?>
                  <script>
                        function submit_modal(){
                            window.open('<?php echo e(url(action('TrainingController@unpublish_training',$training->id))); ?>','_self')
                            //$('#form_delete').submit();
                        }
                    </script>
                ...
                >
                    ...
                    <script>
                        function submit_modal_delete_training(){
                            window.open('<?php echo e(url(action('TrainingController@delete_training',$training->id))); ?>','_self')
                            //$('#form_delete').submit();
                        }
                    </script>
                  <!-- Modal Delete Chapter -->
