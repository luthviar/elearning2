		            ...
		            <div class="box-body">
		              <table id="score" class="table table-bordered table-striped">
		                ...
		                <tr>
		                	...
		                	<td>
                                <a
                                    onclick="window.open('<?php echo e(URL::asset($record->attachment_url)); ?>',
                            ...
                            <td>
                                <a
                                    data-toggle="modal" data-target="#myModal<?php echo e($record->id); ?>"
                        ...
                        <script>
                            function submit_modal<?php echo e($record->id); ?>(){
                                window.open('<?php echo e(url(action('UserController@delete_score',$record->id))); ?>','_self')
                                //$('#form_delete').submit();
                            }
                        </script>
                        <!-- Modal Delete Score -->
                        <div class="modal fade" id="myModal<?php echo e($record->id); ?>"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="submit_button"
                                                onclick="submit_modal<?php echo e($record->id); ?>()"
