                    ...
                    <div class="">
                        ...
                        <div class="" >
                            <form
                                    ...
                                    action="<?php echo e(URL::action('NewsController@updateCommentByUser')); ?>"
                        ...
                        <script>
                            function submit_modal<?php echo e($key); ?>(){
                                window.open('<?php echo e(url(action('NewsController@deleteAttachmentCommentByUser',$file->id))); ?>','_self')
                                //$('#form_delete').submit();
                            }
                        </script>
